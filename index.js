...
const GOOGLE_SCRIPT_URL_THAM_DU =
  "https://script.google.com/macros/s/AKfycbw79qTaSrPsV6JfhXgxjBHVPmQCNTEtxY1SNwF6LwAU0KizRXpQIbPjAxeZ4FSDAvN2mg/exec";
document
  ...
  .addEventListener("submit", function (e) {
    ...
    let selected = formData.getAll("form_item8");
    let selected_12 = formData.getAll("form_item12");
    let selected_13 = formData.getAll("form_item13");
    let selected_6 = formData.getAll("form_item6");

    const data = {
      name: "'" + form.name.value,
      form_item6: "'" + selected_6.join(", "),
      form_item23: "'" + form.form_item23.value,
      form_item13: "'" + selected_13.join(", "),
      form_item8: "'" + selected.join(", "),
      form_item12: "'" + selected_12.join(", "),
